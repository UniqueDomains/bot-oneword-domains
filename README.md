...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-6%2C253%20rows-8250df">
...
**Public extract:** 6,253 rows · **Live catalog:** 6,251 domains
...
- `bot.csv` — public CSV extract (6,253 rows)
- `bot.json` — public JSON extract (6,253 rows)
...
| ----------------------- | ------------------------------------------------ |
| 6,253-row public sample | 6,251 live domains                               |
...
> Unique Domains. *Available .BOT One-Word Domains*. Version 2026-04-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
