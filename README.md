...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-6%2C237%20rows-8250df">
...
> **Important:** this repository is a **public 6,237-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **6,251 domains** on the canonical page below.

**Public extract:** 6,237 rows · **Live catalog:** 6,251 domains
...
- `bot.csv` — public CSV extract (6,237 rows)
- `bot.json` — public JSON extract (6,237 rows)
...
| -------------- | --------- | ----------- | ------------- | -------------- | ------ | ------ | --------------- |
| temple.bot     | available | $78.98      | —             | 60             | 82     | 6      | namecheap       |
| cloud.bot      | resell    | $6,500      | $6,500        | 70             | 59     | 5      | Dynadot, LLC    |
| standard.bot   | premium   | $137,021.78 | —             | 70             | 70     | 8      | Dynadot, LLC    |
| nationwide.bot | available | $39.99      | $99.99        | 76             | 66     | 10     | name.com        |
| live.bot       | resell    | $6,250      | $6,250        | 108            | 55     | 4      | Dynadot, LLC    |
| power.bot      | premium   | $3,250      | $3,250        | 98             | 62     | 5      | namecheap       |
...
| wicked.bot     | available | $39.99      | $99.99        | 70             | 28     | 6      | name.com        |
...
| ----------------------- | ------------------------------------------------ |
| 6,237-row public sample | 6,251 live domains                               |
...
> Unique Domains. *Available .BOT One-Word Domains*. Version 2026-04-14. Public GitHub extract for the exact Unique Domains search represented by this repository.
