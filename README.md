...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-6%2C252%20rows-8250df">
...
Daily-updated dataset of available and resale .bot one-word domains from Unique Domains.

> **Note:** this repository currently mirrors the full live catalog for this exact search.
> Unique Domains counts can still change as the search refreshes.

**Public extract:** 6,252 rows · **Live catalog:** 6,252 domains
...
- `bot.csv` — public CSV extract (6,252 rows)
- `bot.json` — public JSON extract (6,252 rows)
...
| ----------------------- | ------------------------------------------------ |
| 6,252-row public sample | 6,252 live domains                               |
...
> Unique Domains. *Available .BOT One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
