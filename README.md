# Available .BOT One-Word Domains (28,206)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-28%2C206%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **28,206 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 28,206 domains · **Median ask:** $148.55 · **High-demand under $2,500:** 10
...
| ------------ | --------- | ----------- | ------------- | -------------- | ------ | ------ | --------------- |
| acne.bot     | available | $64.99      | $64.99        | low            | low    | 4      | namesilo        |
| size.bot     | resell    | $7,528.68   | —             | high           | low    | 4      | EnCirca, Inc.   |
| ago.bot      | premium   | $116        | $116          | low            | low    | 3      | namesilo        |
...
| dull.bot     | available | $64.99      | $64.99        | low            | low    | 4      | namesilo        |
...
| fat.bot      | premium   | $625        | —             | medium         | low    | 3      | name.com        |
| lick.bot     | available | $64.99      | $64.99        | medium         | low    | 4      | namesilo        |
| bit.bot      | resell    | —           | —             | high           | medium | 3      | Porkbun LLC     |
| gas.bot      | premium   | $3,450      | $3,450        | low            | low    | 3      | namesilo        |
| loud.bot     | available | $64.99      | $64.99        | medium         | low    | 4      | namesilo        |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 28,206 live domains                        |
...
> Unique Domains. *Available .BOT One-Word Domains*. Version 2026-09-23. Public GitHub extract for the exact Unique Domains search represented by this repository.
